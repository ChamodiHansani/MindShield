...
def main():
    ...
    model = DecisionTreeClassifier(random_state=RANDOM_STATE, max_depth=50)
    model.fit(X_train_vec, y_train)

    y_pred = model.predict(X_test_vec)
    evaluate_and_save("decision_tree_tfidf", y_test, y_pred, class_names)
